...
**![2018_Java学习路线图](路线图/1.jpg)**



![2018_Java学习路线图](路线图/2.jpg) 



![2018_Java学习路线图](路线图/3.jpg)



![2018_Java学习路线图](路线图/4.jpg)



功能上是等价的。不加-r或者－R的时候，只拷贝文件，不拷贝文件夹；加上后则会拷贝文件夹——包括下一级的子文件夹，以及子文件夹中的子文件夹，余此类推。 另外rm的－R －r功能同上 ls的－R功能同上，-r的功能是结果反向排列 